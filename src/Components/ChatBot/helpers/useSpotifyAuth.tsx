...
////////////////////////////////////////////////////  CHECKING FOR CROSS SITE ATTACKS BY CONFIRMING STATEKEY IS VALID ////////////////////////////////////////////////////
  ...
  function isConfirmedCrossSiteAttack(stateKey: string | null) {
...
////////////////////////////////////////////////////  HANDLING AUTHENTICATION ERROR  ////////////////////////////////////////////////////
  ...
  function handleSpotifyAuthenticationError(stateKey: string | null) {
...
////////////////////////////////////////////////////  AUTH SUCCESSFUL RETRIEVING ACCESS TOKENS  ////////////////////////////////////////////////////
  ...
  function retrieveSpotifyAccessTokens(stateKey: string | null, code: string | null) {
    if (stateKey === 'spotify_auth_first_button') {
